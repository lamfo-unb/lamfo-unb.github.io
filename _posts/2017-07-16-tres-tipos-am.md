---
layout: post
title: Três Tipos de Aprendizado
...
Poderíamos fornecer ao computador dados sobre o técnico, composição do time, formação tática, ete, seguidos dos resultados das partidas. Com um grande volume de dados em formato de pares **(variáveis, resultados)**,  esperamos que o computador possa aprender quais padrões levam à vitória. Também esperamos que o computador acerte mais conforme lhe apresentamos mais dados, pois ele terá mais exemplos de padrões que pode **generalizar** para situações ainda não vistas. Assim, quanto mais dados, isto é, quanto mais experiência, melhores serão os resultados, isto é, melhor serpa nossa **performance**

## Aprendizado Supervisionado

Isto é o que chamamos de **Aprendizado de Máquina Supervisionado**
É quando tentamos prever uma **variável dependente** a partir de uma lista de **variáveis independes**. Por exemplo:
